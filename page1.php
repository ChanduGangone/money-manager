					...
					<div class="facts">
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<p>Password </p>
								<input type="password"  value="" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required>
										<p>Contact No. </p>
								<input type="tel" value="" name="contact" pattern="[0-9]{10}" required>
								<div class="sign-up">
			 ...
			 <div class="tab-2 resp-tab-content" aria-labelledby="tab_item-1">
					 	<div class="facts">
							...
							<form name="login" action="" method="post">
								<input type="email" class="email" name="uemail" value="" placeholder="Enter your registered email"  ><a href="#" class=" icon email"></a>
